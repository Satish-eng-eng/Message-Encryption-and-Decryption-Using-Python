...
label3 = Label(wn, text='Result', font=('#6134eb',10))
...
ShowBtn = Button(wn,text="Show Message",bg='#3474eb', fg='black',width=15,height=1,command=Result)
ShowBtn['font'] = font.Font( size=12)
ShowBtn.place(x=180,y=400)

ResetBtn = Button(wn, text='Reset', bg='#eb3453', fg='black', width=15,height=1,command=Reset)
ResetBtn['font'] = font.Font( size=12)
ResetBtn.place(x=15,y=400)

QuitBtn = Button(wn, text='Exit', bg='#eb3a34', fg='black',width=15,height=1, command=wn.destroy)
